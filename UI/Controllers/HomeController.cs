...
namespace UI.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public HomeController(IUserService UserService, IContactUsService ContactUsService, IMessageService MessageService, IAboutUsService AboutUsService, IViewRenderService ViewRenderService)
        {
